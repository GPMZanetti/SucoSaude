...
function getItem(nomeDoDeposito, nomeDoItem, funcao) {
    console.log(`Recuperando item do depósito: ${nomeDoDeposito}, chave: ${nomeDoItem}`);
...
function enviarItem(nomeDoDeposito, nomeDoItem, textoDoArquivo) {
    console.log(`Criando o novo item: ${nomeDoItem}`);
    ...
    .then(() => {
        console.log(`O item ${nomeDoItem} foi criado!`);
    })
    .catch(registrarErro);
}
...
function excluirItem(nomeDoDeposito, nomeDoItem) {
    console.log(`Excluindo o item ${nomeDoItem}`);
